...
void m4ul_cable_detect_register(void)
{
...
static struct platform_device msm8930_device_ext_5v_vreg __devinitdata = {
	...
	.dev	= {
		.platform_data = &msm8930_gpio_regulator_pdata[GPIO_VREG_ID_EXT_5V],
	},
};
...
static struct platform_device msm8930_device_ext_l2_vreg __devinitdata = {
	...
	.id	= 91,
	.dev	= {
		.platform_data = &msm8930_gpio_regulator_pdata[GPIO_VREG_ID_EXT_L2],
	},
};
...
static struct platform_device msm8930_DVT1_2_device_rpm_regulator __devinitdata = {
	.name	= "rpm-regulator",
	.id	= -1,
	.dev	= {
#ifndef MSM8930_PHASE_2
		.platform_data = &msm_rpm_regulator_pdata,
#else
		.platform_data = &msm8930_DVT1_2_device_rpm_regulator_pdata,
#endif
	},
};
...
static void __init m4_init(void)
{
	...
	if (system_rev == XC && skuid == 0x03)
		platform_device_register(&msm8930_DVT1_2_device_rpm_regulator);
